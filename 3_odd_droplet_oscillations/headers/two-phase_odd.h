// #include "vof_no_advect.h"
#include "vof.h"

scalar f[], * interfaces = {f};

double rho1 = 1., mu1 = 0., rho2 = 1., mu2 = 0.;
double mu_odd1 = 0.0, mu_odd2 = 0.0;
...
#endif
#ifndef mu_odd
# define mu_odd(f)  (clamp(f,0.,1.)*(mu_odd1 - mu_odd2) + mu_odd2)
#endif
...
event properties (i++)
{
  foreach_face() {
    ...
    if (mu_odd1 || mu_odd2) {
      face vector muv = mu_odd;
      muv.x[] = fm.x[]*mu_odd(ff);
    }
  }
